...
import { useSketchOptions } from '../store'
...
<template>
  <NScrollbar class="flex-1 max-w-[240px] p-[16px] max-h-[calc(100vh-128px)]">
    <NForm ref="formRef" label-placement="left" size="large" class="svg-option-form">
      ...
      <NFormItem label="background">
        <NColorPicker v-model:value="sketchOptions.value.backgroundColor" :modes="['hex']" :actions="['clear']" />
      </NFormItem>
    </NForm>
  </NScrollbar>
</template>
